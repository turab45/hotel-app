...
public class HotelController {
	...
	@GetMapping("/api/hotels/city/{city}")
	...
	@GetMapping("/api/hotels/menu/{menu}")
	...
	@GetMapping("/api/hotels/partner/{partnerName}")
	...
	@GetMapping("/api/hotels/location/{location}")
	...
	@GetMapping("/api/hotels/{location}/{menu}")
